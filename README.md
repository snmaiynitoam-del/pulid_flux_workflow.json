# pulid_flux_workflow.json

Dockerized ComfyUI workflow: pulid_flux_workflow.json
...
docker build -t pulid_flux_workflow.json .

# Run the container
docker run -p 8188:8188 pulid_flux_workflow.json
```
